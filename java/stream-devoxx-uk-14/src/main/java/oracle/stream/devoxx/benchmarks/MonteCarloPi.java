...
java -Xmx1g -XX:-TieredCompilation -XX:MaxInlineLevel=12 -jar target/microbenchmarks.jar -f 2 -rf csv -rff MonteCarloPi.csv ".*MonteCarloPi.*"
 */
...
public class MonteCarloPi {
    ...
    @GenerateMicroBenchmark
    public double sequentialFilter() {
        long m = SplittableRandoms.generators(N)
                .filter(sr -> {
                    double x = sr.nextDouble(-1, 1);
                    double y = sr.nextDouble(-1, 1);
